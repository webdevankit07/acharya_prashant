                        ...
                        {otherVideos.map((elem) => {
                            ...
                            return (
                                <div key={elem.id}>
                                    ...
                                    >
                                        <div className='cursor-pointer flex gap-4 md:gap-5 py-5 md:py-10 px-1 md:px-3 hover:bg-[#F1F5F9] rounded-md'>
                                            <div className='imageWrapper relative w-[180px] md:w-[150px] h-[100px] md:h-[80px]'>
                                            ...
                                            <div className='h-[100px]'>
                                                ...
                                                <h3 className='text-2xl text-gray-700 my-3'>{subtitle}</h3>
